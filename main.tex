...
\titleformat{\subsubsection}[hang] % "runin" = inline nadpis (v textu), lze změnit na "hang"
...
\begin{document}
	...
	\begin{enumerate}
		...
		\begin{itemize}
			\item \textbf{Název události} – například \uv{Koncert varhanní hudby}.
	...
	\begin{enumerate}
		...
		\item Vyplňte:
		\begin{itemize}
			\item \textbf{Název místa} – např. \uv{Kostel Nanebevzetí Panny Marie}.
